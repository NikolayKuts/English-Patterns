...
object IrregularVerbsStorage {
    ...
    val fullyChanging = IrregularVerbsGroup.FullyChanging(
        ...
        x_anX_uXX = IrregularVerbsGroup.FullyChanging.SubGroup.X_anX_uXX(
            data = listOf(
                VerbDetails(
                    word = "Начинать",
        ...
        x_oXe_Xen = IrregularVerbsGroup.FullyChanging.SubGroup.X_oXe_Xen(
            data = listOf(
                VerbDetails(
                    word = "Ломать",
        ...
        iXe_oXe_Xen = IrregularVerbsGroup.FullyChanging.SubGroup.IXe_oXe_Xen(
            data = listOf(
                VerbDetails(
                    word = "Водить",
        ...
        some = IrregularVerbsGroup.FullyChanging.SubGroup.Some(
            data = listOf(
                VerbDetails(
                    word = "Забывать",
        ...
        x_ew_wn = IrregularVerbsGroup.FullyChanging.SubGroup.X_ew_wn(
            data = listOf(
                VerbDetails(
                    word = "Летать",
        ...
        x_aXe_Xen = IrregularVerbsGroup.FullyChanging.SubGroup.X_aXe_Xen(
            data = listOf(
                VerbDetails(
                    word = "Прощать",
